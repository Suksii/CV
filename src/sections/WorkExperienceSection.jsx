...
const WorkExperienceSection = () => {
    ...
    const workExperience = [
        ...
        },
        {
            ...
            description: "As a broadcast engineer at the national television station, I maintain complex systems, including Avid's MediaCentral, iNEWS, MediaComposer, Maestro, iNEWS Command, and Airspeed, essential for production, broadcasting, graphics, editing, archiving, material ingestion, and conversion. I also maintain the Yes system for broadcasting and recording by SiMedia. Additionally, I support employees in production, technical, and news departments, ensuring continuous and efficient operation of all processes."
        },
        {
